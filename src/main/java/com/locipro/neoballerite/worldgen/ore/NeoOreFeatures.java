...
//        CONFIGURED_FEATURES.register("ore_ballerite", )
        ...
        FeatureUtils.register(context, ORE_BALLERITE, Feature.ORE, new OreConfiguration(ballerite_target, 9, 0.4f));
        FeatureUtils.register(context, ORE_LEAD, Feature.ORE, new OreConfiguration(lead_target, 8, 0.8f));
